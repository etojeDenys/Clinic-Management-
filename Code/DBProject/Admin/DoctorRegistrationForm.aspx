                            ...
                            <div class="col-sm-8">
                             ...
                             <asp:RangeValidator ID="RangeValidator1" runat="server" ErrorMessage="Experience Range should be (0-5)" MinimumValue="0" MaximumValue="5" Type="Integer" ControlToValidate="Exp" Display="Dynamic" ForeColor="Red"></asp:RangeValidator>   
                                         ...
                                         <div class="form-group">
                                             ...
                                             <asp:TextBox ID="Salary" runat="server" type="text"  placeholder="Salary in UAH" Width="221px" ></asp:TextBox>

                                                <asp:TextBox ID="Charges_per_visit" runat="server" type="text"  placeholder="Charges_per_visit in UAH" Width="227px" ></asp:TextBox>
